...
static const int systraypinningfailfirst = 1; /* 1: if pinning fails,display systray on the 1st monitor,False: display
...
static const int new_window_attach_on_end = 0; /*  1 means the new window will attach on the end; 0 means the new window
...
static const Key keys[] = {
        ...
        {MODKEY, XK_m, spawn, SHCMD(".config/rofi/bin/launcher")},
        {MODKEY, XK_Return, spawn, SHCMD("kitty")},
        {MODKEY, XK_e, spawn, SHCMD("nemo")},
        {MODKEY, XK_p, spawn,
         SHCMD("xrandr --output eDP-1 --off --output DP-1 --off --output HDMI-1 "
               "--primary --mode 1920x1080 --pos 0x0 --rotate normal")},
        {MODKEY, XK_o, spawn, SHCMD("xrandr --output eDP-1 --mode 1366x768 --pos 0x0 --rotate normal")},
        {MODKEY, XK_b, spawn, SHCMD("brave")},
        {MODKEY, XK_Print, spawn, SHCMD(".config/rofi/bin/screenshot")},
